...
import me.shetj.base.pay.alipay.Alipay;
import me.shetj.base.pay.weixin.WeiXinPay;
...
public class JPay {
    ...
    public void toAliPay(String payParameters, JPayListener listener) {
        if (payParameters != null) {
            ...
            if (listener != null) {
                listener.onPayError(Alipay.PAY_PARAMETERS_ERROR, "参数异常");
            }
        }
    }
}

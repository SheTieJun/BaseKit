package me.shetj.base.decoration;
 ...
 *
 *  <br>  recyclerView.addItemDecoration(Divider.builder()
 *  <br> .color(Color.BLUE)// 设颜色
 * <br>  .width(10)// 设线宽px，用于画垂直线
 * <br>  .height(20)// 设线高px，用于画水平线
 * <br>  .headerCount(1)// 设头的数量
...
public class Decoration extends RecyclerView.ItemDecoration {
     ...
     * Divider的构建者
     */
    public static Decoration.Builder builder() {
        return new Decoration.Builder();
    }

    public static class Builder {

        private final Decoration divider;

        Builder() {
            divider = new Decoration();
        }

package shetj.me.base.common.buttomtablayout;
...
public class BottomTab {
    ...
    public BottomTab(String tabName, int tabNameUnSelectColor, int tabNameSelectColor, int tabUnSelectIcon, int tabSelectIcon) {

...
public final class WheelView extends ViewGroup {
    ...
    public static abstract class ItemPainter {
        ...
        //画矩形
        protected void drawRect(@NonNull Canvas c, @NonNull Rect parentRect) {
        }
    }
    ...
    public static abstract class DrawManager extends RecyclerView.ItemDecoration {
        ...
        protected void preDecoration(@NonNull Canvas c, @NonNull Rect parentRect) {
            ...
            itemPainter.drawRect(c, parentRect);
        }
    ...
    public static class SimpleItemPainter extends ItemPainter {
        ...
        //背景矩形
        private final Paint curtainPaint = new Paint();
        ...
        protected void setWheelParams(@NonNull WheelParams params) {
            ...
            curtainPaint.setAntiAlias(true);
            curtainPaint.setColor(params.curtainColor);
        }
        ...
        @Override
        protected void drawRect(@NonNull Canvas c, @NonNull Rect parentRect) {
            super.drawRect(c, parentRect);
            if (wheelParams.curtainEnable){
                if (wheelParams.isVertical()) {
                    ...
                    c.drawRoundRect(parentRect.left, firstY, parentRect.right, secondY, 18, 18, curtainPaint);
                }else {
                    ...
                    c.drawRoundRect(firstX, parentRect.top, secondX, parentRect.bottom, 18, 18, curtainPaint);
                }
            }
        }

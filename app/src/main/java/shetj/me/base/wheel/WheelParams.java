...
public final class WheelParams {
    ...
    //背景矩形
    public final boolean curtainEnable;
    public @ColorInt int curtainColor;
    public @Px float curtainRadius;
    ...
    private WheelParams(Builder builder) {
        ...
        this.curtainEnable = builder.curtainEnable;
        this.curtainColor = builder.curtainColor;
        this.curtainRadius = builder.curtainRadius;
    ...
    public final static class Builder {
        ...
        boolean curtainEnable = false;
        @ColorInt int curtainColor = Color.GRAY;
        @Px float curtainRadius = 18;
        ...
        Builder(Context context, AttributeSet attrs) {
            if (attrs != null) {
                ...
                curtainRadius = a.getDimension(R.styleable.WheelView_wheelCurtainRadius,curtainRadius);
                curtainEnable = a.getBoolean(R.styleable.WheelView_wheelCurtainEnabled,curtainEnable);
                curtainColor = a.getColor(R.styleable.WheelView_wheelCurtainColor,curtainColor);
                a.recycle();
            }
        }
        ...
        public Builder setCurtainEnable(boolean curtainEnable) {
            this.curtainEnable = curtainEnable;
            return this;
        }

        public Builder setCurtainColor(int curtainColor) {
            this.curtainColor = curtainColor;
            return this;
        }

        public Builder setCurtainRadius(float curtainRadius) {
